...
function update_notifier() { 
	...
	<div class="wrap">
        ...
        <div id="instructions" style="max-width: 800px;">
            ...
            <p>To update the Theme, download it from <a href="http://minimable.fedeweb.net" target="_blank">http://minimable.fedeweb.net</a></p>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://minimable.fedeweb.net/notifier.xml';
